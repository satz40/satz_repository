...
public class GreensTech3 {
	public static void main(String[] args) {
		...
		WebElement training=driver.findElement(By.partialLinkText("Data Warehousing Trai"));
		ac.moveToElement(training).perform();
		WebElement trainingCourse=driver.findElement(By.linkText("Microstrategy Training"));
